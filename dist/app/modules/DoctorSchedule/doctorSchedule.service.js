...
const getMyScheduleFromDb = (filters, options, user) => __awaiter(void 0, void 0, void 0, function* () {
...
const deleteDoctorScheduleFromDB = (user, scheduleId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isBookedSchedule) {
        throw new AppError_1.default(httpStatus.BAD_REQUEST, 'You can not delete the schedule because of the schedule is already booked!');
    }
